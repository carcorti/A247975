...
b-file for A247975.
The C~source code for the main search (\texttt{fase6.c}), the
independent verification sieve (\texttt{verify\_min.c}), and the
Python/SymPy verification scripts will be deposited in a public
repository (GitHub, with a permanent Zenodo archive and DOI) upon
acceptance, together with the full machine-readable dataset and
...
Anthropic's Claude language models (claude-sonnet-4-6 and claude-opus-4-6). Claude also assisted substantially in the
