...
We determine $a(m)$ for $119\,995$ of the values $m = 1, 2, \ldots,
120\,000$, with final search bound $n \leq 2 \times 10^{11}$;
...
extended search resolved $64$ of those $69$ cases,
reducing the unresolved count to~$5$.
Among the $119\,995$ resolved values we identify $606$ exceptional
...
$a(m) = 47\,572\,503\,750$ (ratio $\approx 196\,577$, the global
maximum among resolved cases), and the largest absolute value
...
The $5$ unresolved values
($m = 37\,249$, $66\,257$, $76\,868$, $98\,379$, $117\,862$)
each have estimated Cram\'er ratios
...
extended-search cases (including the $4$ with the largest Cram\'er
ratios and all $9$ cases with $a(m) \in [10^{10}, 3 \times 10^{10}]$).
\end{abstract}
...
$m \leq 120\,000$ are listed in Table~\ref{tab:ratio}.
...
The distribution of $a(m)$ for resolved $m = 1, \ldots,\allowbreak 120\,000$ is
