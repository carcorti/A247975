/*
 * sun41_v12.c  --  Targeted search for unresolved cases of Sun's Conjecture 4.1(i)
 *
 ...
 *       sun41_v12.c -o sun41_v12 -lm
 *
 * Usage:
 *   ./sun41_v12 [BOUND [BLOCK_SIZE]]
...
/* Phase-6 search bound (n-index). v12 continues from here. */
#define PHASE6_BOUND  2000000000LL

/* ================================================================== */
/*  The 49 unresolved m-values from Phase 6                           */
/*  Source: Table "Unresolved Cases", sun41_v6b.c run, log_fase6.txt  */
/* ================================================================== */
static const int UNRESOLVED_M[] = {
    11924, 18241, 19234, 20686, 22186, 22802, 23995,
    33566, 36303, 36726, 37249, 37253, 37949, 43297,
    48834, 49889, 51816, 53963, 55468, 55874, 61007,
    66257, 67203, 67273, 67447, 68744, 69546, 71049,
    72568, 76761, 76868, 81986, 82096, 82300, 84521,
    86557, 90005, 90161, 92335, 93790, 93890, 94429,
    94768, 97251, 97351, 98008, 98258, 98379, 99105
};
...
int main(int argc, char *argv[])
{
    ...
    time_t t0 = time(NULL);
    fprintf(stderr,
        "sun41_v12 -- targeted segmented-sieve search (A247975)\n");
    fprintf(stderr, "  Unresolved cases : %d (from Phase 6, n-bound 2e9)\n",
            N_UNRESOLVED);
    ...
    /* ---- CSV output ---- */
    printf("# sun41_v12: targeted search for A247975 unresolved cases\n");
