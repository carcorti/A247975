/*
 * sun41_v12e.c  --  Targeted search for unresolved cases of Sun's Conjecture 4.1(i)
 *
 ...
 *       sun41_v12e.c -o sun41_v12e -lm
 *
 * Usage:
 *   ./sun41_v12e [BOUND [BLOCK_SIZE]]
...
/* Phase-4 search bound (n-index). v12e continues from here. */
#define PHASE6_BOUND  6000000000LL

/* ================================================================== */
/*  The 25 unresolved m-values after Phase 4 (n-bound 6e9)           */
/*  Removed (resolved in fase 4): 19234, 81986, 94429, 97351, 99105. */
/* ================================================================== */
static const int UNRESOLVED_M[] = {
    11924, 22186, 22802, 23995, 37249, 37253, 37949,
    43297, 48834, 51816, 53963, 55468, 55874, 66257,
    67203, 67447, 69546, 76761, 76868, 82096, 82300,
    86557, 97251, 98258, 98379
};
...
int main(int argc, char *argv[])
{
    ...
    time_t t0 = time(NULL);
    fprintf(stderr,
        "sun41_v12e -- targeted segmented-sieve search (A247975)\n");
    fprintf(stderr, "  Unresolved cases : %d (after fase 4, n-bound 6e9)\n",
            N_UNRESOLVED);
    ...
    /* ---- CSV output ---- */
    printf("# sun41_v12e: targeted search for A247975 unresolved cases\n");
