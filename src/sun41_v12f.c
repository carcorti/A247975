/*
 * sun41_v12f.c  --  Targeted search for unresolved cases of Sun's Conjecture 4.1(i)
 *
 ...
 *
 * CHANGES v12f (step 1: n = 7e9 .. 10e9):
 *   - PHASE6_BOUND updated to 7000000000 (fase-5 bound).
 *   - UNRESOLVED_M: 21 cases remaining after fase 5.
 *     Resolved in fase 5: 11924, 22186, 76761, 86557.
 *   - Binary renamed sun41_v12f.
 *
 ...
 *       sun41_v12f.c -o sun41_v12f -lm
 *
 * Usage:
 *   ./sun41_v12f [BOUND [BLOCK_SIZE]]
...
/* Phase-5 search bound (n-index). v12f continues from here. */
#define PHASE6_BOUND  7000000000LL

/* ================================================================== */
/*  The 21 unresolved m-values after Phase 5 (n-bound 7e9)           */
/*  Removed (resolved in fase 5): 11924, 22186, 76761, 86557.        */
/* ================================================================== */
static const int UNRESOLVED_M[] = {
    22802, 23995, 37249, 37253, 37949, 43297, 48834,
    51816, 53963, 55468, 55874, 66257, 67203, 67447,
    69546, 76868, 82096, 82300, 97251, 98258, 98379
};
...
int main(int argc, char *argv[])
{
    ...
    time_t t0 = time(NULL);
    fprintf(stderr,
        "sun41_v12f -- targeted segmented-sieve search (A247975)\n");
    fprintf(stderr, "  Unresolved cases : %d (after fase 5, n-bound 7e9)\n",
            N_UNRESOLVED);
    ...
    /* ---- CSV output ---- */
    printf("# sun41_v12f: targeted search for A247975 unresolved cases\n");
