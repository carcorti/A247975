/*
 * sun41_v12g.c  --  Targeted search for unresolved cases of Sun's Conjecture 4.1(i)
 *
 ...
 *       sun41_v12g.c -o sun41_v12g -lm
 *
 * Usage:
 *   ./sun41_v12g [BOUND [BLOCK_SIZE]]
...
/* Step-1 search bound (n-index). v12g continues from here.          */
/* NOTE: Update UNRESOLVED_M below with step-1 results before compiling. */
#define PHASE6_BOUND  10000000000LL

/* ================================================================== */
/*  The 15 unresolved m-values after Step 1 (n-bound 10e9)           */
/*  Removed (resolved in step 1): 55874, 67203, 82096, 67447,        */
/*                                 97251, 98258.                      */
/* ================================================================== */
static const int UNRESOLVED_M[] = {
    22802, 23995, 37249, 37253, 37949, 43297, 48834,
    51816, 53963, 55468, 66257, 69546, 76868, 82300,
    98379
};
...
int main(int argc, char *argv[])
{
    ...
    time_t t0 = time(NULL);
    fprintf(stderr,
        "sun41_v12g -- targeted segmented-sieve search (A247975)\n");
    fprintf(stderr, "  Unresolved cases : %d (after step 1, n-bound 10e9)\n",
            N_UNRESOLVED);
    ...
    /* ---- CSV output ---- */
    printf("# sun41_v12g: targeted search for A247975 unresolved cases\n");
