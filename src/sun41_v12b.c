/*
 * sun41_v12b.c  --  Targeted search for unresolved cases of Sun's Conjecture 4.1(i)
 *
 ...
 *       sun41_v12b.c -o sun41_v12b -lm
 *
 * Usage:
 *   ./sun41_v12b [BOUND [BLOCK_SIZE]]
...
/* Phase-1 search bound (n-index). v12b continues from here. */
#define PHASE6_BOUND  3000000000LL

/* ================================================================== */
/*  The 38 unresolved m-values after Phase 1 (n-bound 3e9)           */
/*  Removed (resolved in fase 1): 18241, 20686, 36726, 67273, 68744, */
/*    71049, 84521, 92335, 93790, 93890, 94768.                       */
/* ================================================================== */
static const int UNRESOLVED_M[] = {
    11924, 19234, 22186, 22802, 23995, 33566, 36303,
    37249, 37253, 37949, 43297, 48834, 49889, 51816,
    53963, 55468, 55874, 61007, 66257, 67203, 67447,
    69546, 72568, 76761, 76868, 81986, 82096, 82300,
    86557, 90005, 90161, 94429, 97251, 97351, 98008,
    98258, 98379, 99105
};
...
int main(int argc, char *argv[])
{
    ...
    time_t t0 = time(NULL);
    fprintf(stderr,
        "sun41_v12b -- targeted segmented-sieve search (A247975)\n");
    fprintf(stderr, "  Unresolved cases : %d (after fase 1, n-bound 3e9)\n",
            N_UNRESOLVED);
    ...
    /* ---- CSV output ---- */
    printf("# sun41_v12b: targeted search for A247975 unresolved cases\n");
