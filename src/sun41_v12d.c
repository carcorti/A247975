/*
 * sun41_v12d.c  --  Targeted search for unresolved cases of Sun's Conjecture 4.1(i)
 *
 ...
 *       sun41_v12d.c -o sun41_v12d -lm
 *
 * Usage:
 *   ./sun41_v12d [BOUND [BLOCK_SIZE]]
...
/* Phase-3 search bound (n-index). v12d continues from here. */
#define PHASE6_BOUND  5000000000LL

/* ================================================================== */
/*  The 30 unresolved m-values after Phase 3 (n-bound 5e9)           */
/*  Removed (resolved in fase 3): 33566, 36303, 72568, 90005.        */
/* ================================================================== */
static const int UNRESOLVED_M[] = {
    11924, 19234, 22186, 22802, 23995, 37249, 37253,
    37949, 43297, 48834, 51816, 53963, 55468, 55874,
    66257, 67203, 67447, 69546, 76761, 76868, 81986,
    82096, 82300, 86557, 94429, 97251, 97351, 98258,
    98379, 99105
};
...
int main(int argc, char *argv[])
{
    ...
    time_t t0 = time(NULL);
    fprintf(stderr,
        "sun41_v12d -- targeted segmented-sieve search (A247975)\n");
    fprintf(stderr, "  Unresolved cases : %d (after fase 3, n-bound 5e9)\n",
            N_UNRESOLVED);
    ...
    /* ---- CSV output ---- */
    printf("# sun41_v12d: targeted search for A247975 unresolved cases\n");
